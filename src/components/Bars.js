...
const Bars = ({ tracks, trackIndex }) => {
  return (
    <div className="input bars-wrapper">
      ...
      <span className="bars-info">
        <span class="track-name">{tracks[trackIndex].trackName}</span>
      </span>
      <span className="bars-info">
        time: <span class="info-big">{tracks[trackIndex].time}</span>
      </span>
      <span className="bars-info">
        <span class="info-big">{tracks[trackIndex].measure}</span> notes
      </span>
    </div>
  );
};
